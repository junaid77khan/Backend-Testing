...
function AllComment({comment}) {
    ...
    const fetchUser = useCallback(async() => {
        try {
            const response = await fetch(`/api/v1/users/user-by-id`, {
                method: "POST",
                headers: {
    ...
    const fetchLikeData = useCallback( async() => {
        const res = await fetch(`https://social-app-latest-4.onrender.com/api/v1/likes/boolComment/b/${comment?._id}`,
        {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
    ...
    const fetchDisLikeData = useCallback( async() => {
        const res = await fetch(`https://social-app-latest-4.onrender.com/api/v1/dislikes/dislikecommentbool/b/${comment?._id}`,
        {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
    ...
    const toggleLike = useCallback( async() => {
        const res = await fetch(`https://social-app-latest-4.onrender.com/api/v1/likes/toggle/c/${comment?._id}`,
        {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
    ...
    const toggleDisLike = useCallback( async() => {
        const res = await fetch(`https://social-app-latest-4.onrender.com/api/v1/dislikes/toggle/c/${comment?._id}`,
        {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
